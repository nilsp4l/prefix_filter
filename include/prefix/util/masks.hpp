...
namespace prefix::util
{
    ...
    {
        static constexpr numberT value{static_cast<numberT>(static_cast<numberT>(1) << ((sizeof(numberT) << 3) - (position + 1)))};
    };
    ...
    {
        static constexpr numberT value{static_cast<numberT>(~((static_cast<numberT>(1) << ((sizeof(numberT) << 3) - (position + 1))) - 1))};
    };
