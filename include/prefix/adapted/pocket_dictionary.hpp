...
namespace prefix::adapted
{
  ...
  public:
    ...
    [[nodiscard]] bool query(uint8_t r) const
    {
      ...
      auto cmp_result{_mm256_cmpeq_epi8(pd_reg, _mm256_set1_epi8(r))};
    ...
    auto max_element_positions{_mm256_movemask_epi8(_mm256_max_epi8(r_reg, pd_reg)) & valid_elements_mask};
